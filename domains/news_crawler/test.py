...
format_category_urls = ['tag/chinh-tri', 'tag/the-che', 'tag/hinh-su', 'tag/viet-nam-cong-hoa'
                            'tag/luat-my', 'tag/luat-quoc-te', 'tag/diem-sach', 'tag/quan-diem' ]

for tag in format_category_urls:
    for i in range (2, 7):
        format_category_urls.append(f'{tag}/page/{i}/')

print(format_category_urls)